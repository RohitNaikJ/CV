...
\item Used PCA in a Facial Recognition Software to greatly reduce the feature space
\end{itemize}
...
% \item Implemented Depth-Limited MiniMax Search, Alpha-Beta Pruning and Transposition Table to improve time complexity and Genetic Algorithm to drastically improve the evaluation function
